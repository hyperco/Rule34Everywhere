...
pahealLink.find("img").attr("src", GM_getResourceURL("paheal_favicon"));
...
function processTextNode(node, tags) {
  ...
  for (i = 0; i < matches.length; i++) {
    ...
    post_list = "http://rule34.paheal.net/post/list/"+tag+"/1";
